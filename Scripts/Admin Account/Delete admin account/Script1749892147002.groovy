...
WebUI.click(findTestObject('Object Repository/Page_Admins - List  E STAFF/button_Delete'))
...
WebUI.getText(findTestObject('Page_Admins - List  E STAFF/div_Successfully deleted organization'))

WebUI.verifyTextPresent('Successfully deleted admin account', false)
