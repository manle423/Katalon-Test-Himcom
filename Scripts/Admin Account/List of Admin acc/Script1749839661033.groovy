...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Admins - List  E STAFF/h4_List of Admin'), 0)

TestObject table = findTestObject('Object Repository/Page_Admins - List  E STAFF/div_Email _Role_Actions_ ngoc.tranhimcom.vn')

WebUI.verifyElementPresent(table, 10)
