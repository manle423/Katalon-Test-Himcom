...
TestObject dropdown = findTestObject('Object Repository/Page_Companies - List  E STAFF/select_')
...
// Nhấn nút Search
WebUI.click(findTestObject('Object Repository/Page_Companies - List  E STAFF/button_Search by project name_btn'))
